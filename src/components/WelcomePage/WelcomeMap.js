        ...
        <div className='welcome-header'>
          <div className='welcome-header-title'>
            <h3
              ...
              style={{ fontSize: '3.5vw' }}>Welcome to
            </h3>
            <br />
        ...
        <div className='welcome-secondary row'>
          ...
          <div className='col-lg-6 col-md-7 col-sm-12'>
            ...
            <p>
                ...
                and Israel. This is a full stack, interactive app with a Mapbox
                integration. We invite you to contribute to the project by
                visiting our open source repository{' '}
              <a href='https://github.com/ProjectPlayGroundLHA'> here</a>.
            </p>
          </div>
        </div>
        <SiteMap />
